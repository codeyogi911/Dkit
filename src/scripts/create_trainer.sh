...
docker-machine create --driver amazonec2 --amazonec2-iam-instance-profile ec2-trainer --amazonec2-ami ami-060865e8b5914b4c4 --amazonec2-root-size 500 --amazonec2-instance-type p3.2xlarge dkit-trainer && \
